...
$show_footer_widgets    = isset( $punte_options[ 'show-footer-widgets' ] ) ? $punte_options[ 'show-footer-widgets' ] : true;

if ( $custom_footer && isset( $punte_options[ 'custom-footer-page' ] ) && !empty( $punte_options[ 'custom-footer-page' ] ) && defined('ELEMENTOR_VERSION') ) {
    ...
    <footer id="colophon" class="site-footer">
        <?php if($show_footer_widgets == true ): ?>
        <div id="top-footer">
